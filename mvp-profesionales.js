...
(function () {
  ...
  function openContract(id) {
    ...
    let actions = `<button class="secondary-button" type="button" onclick="window.print()">Imprimir expediente actualizado</button><a class="secondary-button button-link" href="plantillas/plantilla-productos-paso-a-paso-vigna.xlsx" download>Descargar plantilla Excel</a>`;
