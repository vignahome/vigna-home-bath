...
for (const archivo of ["privacidad-vigna.html", "terminos-vigna.html", "soporte-vigna.html", "eliminar-cuenta.html", "libro-reclamaciones.html", "legal-vigna.css"]) exigir(fs.existsSync(archivo), `Falta ${archivo}`);
...
exigir(html.includes("libro-reclamaciones.html"), "Falta acceso visible al Libro de Reclamaciones.");
...
for (const archivo of ["privacidad-vigna.html", "terminos-vigna.html", "soporte-vigna.html", "eliminar-cuenta.html", "libro-reclamaciones.html", "legal-vigna.css"]) exigir(build.includes(`"${archivo}"`), `El build no incluye ${archivo}`);
