...
for (const archivo of ["privacidad-vigna.html", "soporte-vigna.html", "eliminar-cuenta.html", "legal-vigna.css"]) exigir(build.includes(`"${archivo}"`), `El build no incluye ${archivo}`);
